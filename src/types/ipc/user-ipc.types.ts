...
export interface CreateUserIPCHandlerReturn extends IPCHandlerReturnWithData<{
    user: UserViewModel
}> {}

// Get Current User
export interface GetCurrentUserIPCHandlerReturn extends IPCHandlerReturnWithData<{
    user: UserViewModel
}> {}
...
export interface SetCurrentUserIPCHandlerReturn extends IPCHandlerReturnWithData<{
    user: UserViewModel
}> {}
...
export interface GetOneUserIPCHandlerReturn extends IPCHandlerReturnWithData<{
    user: UserViewModel
}> {}

// Get All
export interface GetAllUsersIPCHandlerReturn extends IPCHandlerReturnWithData<{
